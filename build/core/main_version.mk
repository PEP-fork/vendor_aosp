...
ifeq ($(IS_ROMODEL_VERSION), true)
CUSTOM_VERSION := PixelExperience_Plus_$(CUSTOM_BUILD)-$(CUSTOM_PLATFORM_VERSION)-$(CUSTOM_BUILD_DATE)-ROMODEL.RU
CUSTOM_VERSION_PROP := eleven-go
else
